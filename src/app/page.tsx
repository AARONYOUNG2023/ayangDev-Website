...
const projects = [
  {
    ...
    period: "Oct 2025",
    bullets: [
      "Built Python web scraper on Google Cloud VM to extract 700,000+ equipment records from Cubyt database",
      "Automated data extraction of model specifications, manufacturer details, and test point configurations using Selenium and BeautifulSoup",
    ],
  ...
  },
  {
    ...
    period: "Jul 2025",
    bullets: [
      "Developed Streamlit analytics dashboard integrating IndySoft calibration database with BigQuery for real-time reporting",
      "Created certificate data browser and extraction tools for multi-branch operations",
    ],
            ...
            {projects.map((proj) => (
              <div key={proj.title}>
                ...
                <p className="mt-2 text-xs text-muted-light">
                  <span className="font-medium text-muted">Tech:</span> {proj.tech}
                </p>
              </div>
            ))}
          </div>
      ...
      <FadeIn>
        <section id="contact">
          ...
          <p className="text-sm text-muted">
            ...
            Reach me at{" "}
            <a href="mailto:yongpuy@upenn.edu" className="font-medium text-accent hover:text-accent-hover">
              yongpuy@upenn.edu
            </a>.
          </p>
        </section>
